...
import com.wipro.springboot.request.LoginForm;
import com.wipro.springboot.response.JwtResponse;
...
public class UserController {
	...
	@PatchMapping("/admin/{email}/remove")
